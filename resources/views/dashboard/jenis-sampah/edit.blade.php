    ...
    <form class="forms-sample" action="/dashboard/jenis-sampah/{{ $jenis_sampah->id_jenis_sampah }}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nama_sampah" id="nama_sampah" placeholder="Nama jenis sampah.."
          value="{{ $jenis_sampah->nama_sampah }}">
      </div>
      <div class="form-group">
        <label for="harga_penarikan_kg">Harga Penarikan/kg</label>
        <input type="number" class="form-control" name="harga_penarikan_kg" id="harga_penarikan_kg"
          placeholder="Harga penarikan per kg.." value="{{ $jenis_sampah->harga_penarikan_kg }}">
      </div>
      <div class="form-group">
        <label for="harga_setoran_kg">Harga Setoran/kg</label>
        <input type="number" class="form-control" name="harga_setoran_kg" id="harga_setoran_kg"
          placeholder="Harga setoran per kg.." value="{{ $jenis_sampah->harga_setoran_kg }}">
      </div>
